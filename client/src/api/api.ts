export const fetchMessage = async () => {
  try {
    console.log(
      "url",
      `${import.meta.env.VITE_API_BASE_URL}/api/frontend/main`,
    );
...
export const fetchTest = async () => {
  try {
    const res = await fetch(
      `${import.meta.env.VITE_API_BASE_URL}/api/frontend/test`,
    );
    console.log(res);
    return res.json();
  } catch (err) {
...
export const fetchBenchmark = async () => {
  try {
    const res = await fetch(
      `${import.meta.env.VITE_API_BASE_URL}/api/frontend/benchmark`,
    );
    console.log(res);
    return res.json();
  } catch (err) {
